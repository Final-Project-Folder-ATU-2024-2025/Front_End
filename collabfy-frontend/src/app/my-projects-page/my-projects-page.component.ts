// =======================================================================
// Import Angular core modules and common functionalities.
// -----------------------------------------------------------------------
import { Component, OnInit } from '@angular/core';      // Provides component lifecycle and metadata
...
import { ApiService } from '../api.service';              // Custom API service to interact with backend
...
import { faCheck, faCircleXmark } from '@fortawesome/free-solid-svg-icons'; // Import icons for modal actions
...
// delete projects, and leave projects. It also handles comment functionality for a
// selected project.
// =======================================================================
@Component({
...
export class MyProjectsPageComponent implements OnInit {
  ...
  // *** Added properties to support comment functionality ***
  selectedProjectId: string = '';   // Holds the project ID currently selected for comment operations
  comments: any[] = [];             // Array of comments for the selected project
  newComment: string = '';          // Holds the new comment text from the user
  ...
  // For filters like 'Deadline' and 'Alphabetical', it sorts the projects accordingly.
  // -----------------------------------------------------------------------
